...
void GroundCollisionSample::CreateBall(Math::Vec2F position) noexcept {
  ...
  circleCol.Shape =
      Math::Circle(Math::Vec2F::Zero(), Math::Random::Range(10.f, 40.f));
  circleCol.BodyPosition = circleBody.Position;
  circleCol.Restitution = 0.f;

  GraphicsData gd;
  gd.Color = {Math::Random::Range(0, 255), Math::Random::Range(0, 255),
              Math::Random::Range(0, 255), 255};
...
void GroundCollisionSample::CreateRect(Math::Vec2F position) noexcept {
  ...
  rectCol.Shape = Math::RectangleF({-Math::Random::Range(1.f, 4.f) * 10.f,
                                    -Math::Random::Range(1.f, 4.f) * 10.f},
                                   {Math::Random::Range(1.f, 4.f) * 10.f,
                                    Math::Random::Range(1.f, 4.f) * 10.f});
